It is common and useful to deploy your `spa-sqladmin` or FastAPI/Starlette application
...
This is not exactly related to the `spa-sqladmin` but more related to how
