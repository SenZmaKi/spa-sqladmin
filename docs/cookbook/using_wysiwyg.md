...
The `content` field will be rendered as a `textarea` in the admin create/edit forms. spa-sqladmin's form schema API will report it as type `"textarea"`, which the React frontend renders accordingly.
